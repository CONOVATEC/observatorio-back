...
class PostController extends Controller
{
    public function  __construct()
    {
        ...
        $this->middleware('can:noticias.create')->only('create');
        $this->middleware('can:noticias.edit')->only(['edit', 'store']);
        $this->middleware('can:noticias.destroy')->only('destroy');
        $this->middleware('can:noticias.eliminar.definitivo')->only('deleteDefinitive');
        $this->middleware('can:noticias.restaurar')->only('restore');
    }
