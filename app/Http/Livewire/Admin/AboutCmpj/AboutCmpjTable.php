...
namespace App\Http\Livewire\Admin\AboutCmpj;

use App\Models\admin\About_cmpj;
use Livewire\Component;

class AboutCmpjTable extends Component
{
     ...
     /* protected $queryString = [
      ...
      public function render()
      {
         /* $categories = Category::where('name', 'like', "%{$this->search}%")
          ...
          $aboutCmpj=About_cmpj::all();
        
          return view('livewire.admin.about-cmpj.about-cmpj-table',compact('aboutCmpj'));
      }
