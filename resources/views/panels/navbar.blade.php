        ...
        <div class="navbar-container d-flex content">
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons">
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('noticias') }}" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            title="Noticias"><i class="ficon" data-feather="globe"></i></a></li>
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('categorias') }}" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            title="categorías"><i class="ficon" data-feather="layers"></i></a></li>
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('etiquetas') }}" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            title="etiquetas"><i class="ficon" data-feather="tag"></i></a></li>
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('usuarios') }}" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            title="Usuarios"><i class="ficon" data-feather="user"></i></a></li>
                </ul>
                {{-- <ul class="nav navbar-nav">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                {{-- <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon" data-feather="search"></i></a>
                    <div class="search-input">
                        ...
                        <input class="form-control input" type="text" placeholder="Buscar" tabindex="-1" data-search="search">
