    ...
    <div class="col-12 ">
        <div class="card mb-1">
            <div class="card-header mb-0 py-0">
                <h4 class="card-title ">Editando rol</h4>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="mb-0 ms-1">Rol</h5>
                </div>
                <i data-feather="more-vertical" class="font-medium-3 cursor-pointer"></i>
            </div>
            <div class="card-body">
                {!! Form::model($role,[ 'route' => ['roles.update',$role], 'method' => 'put','class' => 'form needs-validation','novalidate'=>'' ]) !!}
            ...
            <div class="card-body ">
                <div class="d-flex justify-content-between overflow-auto">
                    <ul class="list-group list-group-flush">
                        ...
                        {{-- @json($role) --}}
                        <li class="list-group-item"><a href="{{ route('roles.edit',$role) }}">{{ $role->name }}</a></li>
                        @empty
