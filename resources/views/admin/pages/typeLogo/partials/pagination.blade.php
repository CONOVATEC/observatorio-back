<div class="overflow-auto flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
    ...
    <div>
        <p class="small text-muted">
            {!! __('Showing') !!}
            <span class="font-medium">{{ $typeLogos->firstItem() }}</span>
            {!! __('to') !!}
            <span class="font-medium">{{ $typeLogos->lastItem() }}</span>
            {!! __('of') !!}
            <span class="font-medium">{{ $typeLogos->total() }}</span>
            {!! __('results') !!}
        </p>
    ...
    <div class="">
        ...
        {{$typeLogos->withQueryString()->links()}}
    </div>
</div>
