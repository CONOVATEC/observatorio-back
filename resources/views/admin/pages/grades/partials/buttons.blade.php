<div class="d-flex align-items-center col-actions">
    @can('logos.edit')
    <a class="dropdown-item" href="{{ route('notasRapidas.edit',$grade) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
        <i class="fa-solid fa-pen-to-square font-medium-2 text-body"></i>
    </a>
    @endcan
    @can('logos.destroy')
    <form method="post" action="{{route('notasRapidas.destroy',$grade->id)}}">
        @method('DELETE')
        @csrf
