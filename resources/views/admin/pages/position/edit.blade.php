    ...
    <div class="col-12 ">
        <div class="card mb-1">
            <div class="card-header mb-0 py-0">
                <h4 class="card-title ">Editando puesto</h4>
...
<div class="row match-height ">
    ...
    <div class="col-lg-8 col-md-6 col-12 ">
        <div class="card">
            ...
            <div class="card-body">
                {!! Form::model($position,[ 'route' => ['posiciones.update',$position->id], 'method' => 'put','class' => 'form needs-validation','novalidate'=>'' ]) !!}
            ...
            <div class="card-body ">
                <div class="d-flex justify-content-between overflow-auto">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><a href="{{ route('posiciones.edit',$position) }}">{{ $position->name }}</a></li>
                        @empty
                        <h5 class="mb-0">Sin Puesto</h5>
                        @endforelse
                    </ul>
                </div>
            </div>
