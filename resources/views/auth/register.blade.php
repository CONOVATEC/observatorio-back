    ...
    <div class="auth-inner my-2">
        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <h4 class="card-title mb-1 text-center">{{ __('Access personal data') }} 🚀</h4>
                <p class="card-text mb-2 text-center">{{ __('Register your real data to access the web system') }}!</p>
