<div class="card">
    <div class="card-header mt-1 mb-0 py-0">
        ...
        <div class="heading-elements py-0">
            <ul class="list-inline">
                ...
                <li>
                    <a href="{{ route('posiciones.create') }}" type="button" class="form-control btn btn-primary btn-sm"><i class="fa-solid fa-circle-plus"></i> Nuevo</a>
                        ...
                        <table class="table table-striped " style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    @if(auth()->user()->can('posiciones.edit') or auth()->user()->can('posiciones.destroy') )
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="d-inline-block text-truncate" style="max-width: 150px;">{{ $position->name }}</span></td>
                                    <td><span class="badge rounded-pill badge-light-primary me-1">{{ $position->created_at->format('d-m-Y') }}</span></td>
                                    @if(auth()->user()->can('posiciones.edit') or auth()->user()->can('posiciones.destroy') )
                                    <td class="text-center">
                                        {{-- Incluimos los botones  --}}
                                        @include('admin.pages.position.partials.buttons')
                                    </td>
                                    @endif
                                </tr>
                                @empty
    ...
    <div class="card-footer">
        ...
        @include('admin.pages.position.partials.pagination')
    </div>
