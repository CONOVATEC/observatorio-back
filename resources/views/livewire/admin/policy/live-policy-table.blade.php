<div class="card">
    <div class="card-header mt-1 mb-0 py-0">
        <h4 class="card-title">Listado de Políticas</h4>
        <div class="heading-elements py-0">
            <ul class="list-inline">
                ...
                <li>
                    <a href="{{ route('politicas.create') }}" type="button" class="form-control btn btn-primary btn-sm"><i class="fa-solid fa-circle-plus"></i> Nuevo</a>
                        ...
                        <table class="table table-striped " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="d-inline-block text-truncate" style="max-width: 150px;">{{ $policy->name }}</span></td>
                                    <td class=""><span class="d-inline-block text-truncate" style="max-width: 250px;">{{ $policy->descripcion }}</span></td>
                                    <td><span class="badge rounded-pill badge-light-primary me-1">{{ $policy->created_at->format('d-m-Y') }}</span></td>
                                    <td class="text-center">
                                        {{-- Incluimos los botones  --}}
                                        @include('admin.pages.policy.partials.buttons')
                                    </td>
                                </tr>
                                @empty
    ...
    <div class="card-footer">
        ...
        @include('admin.pages.policy.partials.pagination')
    </div>
