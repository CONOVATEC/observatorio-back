...
<div class="misc-wrapper">
    ...
    <div class="misc-inner p-2 p-sm-3">
        <div class="w-100 text-center">
            ...
            <p class="mb-2">¡Ups! 😖 La página solicitada no se encontró en este servidor.</p>
            <a class="btn btn-primary mb-2 btn-sm-block" href="{{ url()->previous()}}"><i class="far fa-hand-point-left"></i> Página anterior</a>
